...
namespace CrxApi.ExLogger
{
    public class ExceptionManagerApi : ExceptionLogger
    {
        ...
        public ExceptionManagerApi()
        {
            ...
            var log4NetConfigFilePath = "C:\\Users\\Naman\\Documents\\GitHub\\NamanSharma_StockMarket\\Middleware\\StockMarket\\StockMarket.AccountAPI\\ExLogger\\log4net.config";
